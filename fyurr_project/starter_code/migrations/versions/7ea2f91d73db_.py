...
Revision ID: 7ea2f91d73db
Revises: 6e9b4f4d42c5
Create Date: 2022-08-21 15:10:45.225189
...
revision = '7ea2f91d73db'
down_revision = '6e9b4f4d42c5'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.drop_column('show', 'upcoming_shows')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('show', sa.Column('upcoming_shows', sa.INTEGER(), autoincrement=False, nullable=True))
